...
{
    public partial class frmBuscarServicio : frmBase
    {
        ...
        private void txtBuscar_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                if (this.txtBuscar.Text != "")
                {
                    ...
                    DataTable dsCatalogo = clsProcesos.DatosGeneral("tarifas", " where upper(descripcionservicio)  like " + cBuscar + " order by descripcionservicio ");
                    ...
                    if (dsCatalogo.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow registro in dsCatalogo.Rows)
                        {
                            ...
                            this.grdCatalogo.Rows.Add(registro["id"], registro["simon"].ToString().Trim(), registro["descripcionservicio"]);
                        }
                    }
                    else
                    {
