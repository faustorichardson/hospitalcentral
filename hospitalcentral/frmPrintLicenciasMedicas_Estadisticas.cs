...
{
    public partial class frmPrintLicenciasMedicas_Estadisticas : frmBase
    {
        public frmPrintLicenciasMedicas_Estadisticas()
        {
            InitializeComponent();
        }

        private void frmPrintLicenciasMedicas_Estadisticas_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" especialidad.especialidad as departamento,");
                sbQuery.Append(" COUNT(licenciamedica.departamento) as cantidad, ");
                sbQuery.Append(" licenciamedica.fecha ");
                sbQuery.Append(" FROM licenciamedica ");
                sbQuery.Append(" INNER JOIN especialidad ON especialidad.idespecialidad = licenciamedica.departamento ");
                ...
                else
                {
                    ...
                    cTitulo = "ESTADISTICAS DE LICENCIAS MEDICAS";

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptLicenciasMedicas_Estadisticas orptLicenciasMedicas_Estadisticas = new rptLicenciasMedicas_Estadisticas();

                    //pasamos el nombre del TITULO del Listado
                    //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                    // oListado.SummaryInfo.ReportTitle = cTitulo;
                    orptLicenciasMedicas_Estadisticas.SummaryInfo.ReportTitle = cTitulo;

                    //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                    frmPrinter ofrmPrinter = new frmPrinter(dtLicenciasMedicas, orptLicenciasMedicas_Estadisticas, cTitulo);
