...
{
    public partial class frmPrintMaterialLaboratorio : frmBase
    {
        public frmPrintMaterialLaboratorio()
        {
            InitializeComponent();
        }

        private void frmPrintMaterialLaboratorio_Load(object sender, EventArgs e)
        {
        ...
        {
            if (rbEntrada.Checked == true) //Imprimir las entradas al inventario
            {
                ...
                cWhere = cWhere + " AND entrada_inventario.anulada = 0";
                string cUsuario = "";
                string cTitulo = "";
                ...
                try
                {
                    ...
                    sbQuery.Append(" entrada_inventario.id, ");
                    sbQuery.Append(" entrada_inventario.idsuplidor, ");
                    sbQuery.Append(" entrada_inventario_detalle.idproducto, ");
                    sbQuery.Append(" entrada_inventario_detalle.producto, ");
                    sbQuery.Append(" entrada_inventario_detalle.cantidad, ");
                    sbQuery.Append(" entrada_inventario.fecha, ");
                    ...
                    //sbQuery.Append(" GROUP BY entrada_inventario_detalle.producto ");
                    ...
                    else
                    {
                        ...
                        cTitulo = "LISTADO DE ENTRADAS AL INVENTARIO DE LABORATORIO";

                        //6to Instanciamos nuestro REPORTE
                        //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                        rptPrintEntradaMaterialLaboratorio orptPrintEntradaMaterialLAboratorio = new rptPrintEntradaMaterialLaboratorio();

                        //pasamos el nombre del TITULO del Listado
                        //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                        // oListado.SummaryInfo.ReportTitle = cTitulo;
                        orptPrintEntradaMaterialLAboratorio.SummaryInfo.ReportTitle = cTitulo;

                        //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                        frmPrinter ofrmPrinter = new frmPrinter(dtMovimientoInventario, orptPrintEntradaMaterialLAboratorio, cTitulo);
            ...
            else // Imprimir las salidas al inventario
            {
            ...
            //    {
                    ...
                    // Otras variables del entorno
                    string cWhere = " WHERE 1 = 1";
                    cWhere = cWhere + " AND salida_inventario.anulada = 0";
                    string cUsuario = "";
                    string cTitulo = "";
                    ...
                    try
                    {
                        ...
                        sbQuery.Clear();
                        sbQuery.Append("SELECT ");
                        sbQuery.Append(" salida_inventario.id,");
                        sbQuery.Append(" salida_inventario.nss,");
                        sbQuery.Append(" salida_inventario.idpaciente,");
                        sbQuery.Append(" pacientes.nombre as nombrepaciente,");
                        sbQuery.Append(" salida_inventario.tipoaccion,");
                        sbQuery.Append(" salida_inventario.fecha,");
                        sbQuery.Append(" salida_inventario_detalle.producto,");
                        sbQuery.Append(" salida_inventario_detalle.cantidad");
                        ...
                        else
                        {
                            ...
                            //nombre del TITULO DEL INFORME
                            cTitulo = "LISTADO DE SALIDAS DEL INVENTARIO DE LABORATORIO";

                            //6to Instanciamos nuestro REPORTE
                            //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                            rptPrintSalidaMaterialLaboratorio orptPrintSalidaMaterialLaboratorio = new rptPrintSalidaMaterialLaboratorio();

                            //pasamos el nombre del TITULO del Listado
                            //SumaryInfo es un objeto que se utiliza para leer,crear y actualizar las propiedades del reporte
                            // oListado.SummaryInfo.ReportTitle = cTitulo;
                            orptPrintSalidaMaterialLaboratorio.SummaryInfo.ReportTitle = cTitulo;

                            //7mo. instanciamos nuestro el FORMULARIO donde esta nuestro ReportViewer
                            frmPrinter ofrmPrinter = new frmPrinter(dtMovimientoInventario, orptPrintSalidaMaterialLaboratorio, cTitulo);
