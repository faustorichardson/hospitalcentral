...
{
    public partial class frmPrintHistoriaClinicaEstadisticas : frmBase
    {
        public frmPrintHistoriaClinicaEstadisticas()
        {
            InitializeComponent();
        }

        private void frmPrintHistoriaClinicaEstadisticas_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sbQuery.Append(" COUNT(historiaclinica.id) as cantidad, historiaclinica.fecha");
                sbQuery.Append(" FROM historiaclinica ");
                sbQuery.Append(cWhere);
                sbQuery.Append(" GROUP BY historiaclinica.fecha");
                ...
                else
                {
                    ...
                    if (rbTodos.Checked == true)
                    {
                        cTitulo = "ESTADISTICAS DE ATENCIONES MEDICAS";
                    }
                    else if (rbSenasa.Checked == true)
                    {
                        cTitulo = "ESTADISTICAS DE ATENCIONES MEDICAS POR SENASA";
                    }
                    else if (rbAccionCivica.Checked == true)
                    {
                        cTitulo = "ESTADISTICAS DE ATENCIONES MEDICAS POR ACCIONES CIVICAS";
                    }

                    //6to Instanciamos nuestro REPORTE
                    //Reportes.ListadoDoctores oListado = new Reportes.ListadoDoctores();
                    rptEstadisticasHistoriaMedica orptListadoHistoriaClinica = new rptEstadisticasHistoriaMedica();
